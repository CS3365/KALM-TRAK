        ...
        for($i = 1; $i <= $min_diff; $i++){
            ...
            if(strcasecmp("Friday", date('l', mktime($hours, $minutes, 0, $month, $day, $year)))== 0 || strcasecmp("Saturday", date('l', mktime($hours, $minutes, 0, $month, $day, $year)))== 0){
                ...
                if ($hours >= 8 && $hours <= 22){
                    ...
                    if ($rand_num > 8){
                        $traker_insert = "INSERT INTO powerticks (`tid`, `when`, `level`) VALUES ('1', '" . $year . "-" . $month . "-" . $day . " " . $hours . ":" . $minutes . ":00', '" . $power . "')";
                    ...
                    // traker is off
                        ...
                        $traker_insert = "INSERT INTO powerticks (`tid`, `when`, `level`) VALUES ('1', '" . $year . "-" . $month . "-" . $day . " " . $hours . ":" . $minutes . ":00', '0')";
                        $result = mysql_query($traker_insert);
                        // Print any errors from retrieving result
                        if(!$result){
